                                            ...
                                            <form action="{{ url('create-order') }}" method="post">
                                                    ...
                                                    @if(dujiaoka_config_get('is_open_img_code') == \App\Models\Goods::STATUS_OPEN)
                                                        <div class="col-12 col-md-6">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <img style="margin-left: 10px; cursor: pointer;" src="{{ captcha_src('buy') . time() }}"
                                                                       title="{{ __('dujiaoka.img_verify_code_refresh') }}"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-12 mt-2">
                                                        ...
                                                        @else
                                                            <button type="submit" id="submit" disabled class="btn btn-outline-primary disabled">
                                                        @endif
                                                            <i class="ali-icon">&#xe7d8;</i>
