                        ...
                        <div class="card m-3">
                            ...
                            <div class="card card-body p-3 border-0">
                                <div class="mx-auto">
                                    ...
                                    <div class="mb-1">
                                        <label>{{ __('order.fields.goods_price') }}:</label>
                                    ...
                                    @if(!empty($coupon))
                                        <div class="mb-1">
                                            <label>{{ __('order.fields.coupon_id') }}:</label>
                                            <span>{{ $coupon['coupon'] }}</span>
                                        </div>
                                        <div class="mb-1">
                                            <label>{{ __('order.fields.coupon_discount_price') }}:</label>
                                            <span>{{ __('dujiaoka.money_symbol') }}{{ $coupon_discount_price }}</span>
                                        </div>
                                    @endif
                                    @if($wholesale_discount_price > 0 )
                                        <div class="mb-1">
                                            <label>{{ __('order.fields.wholesale_discount_price') }}:</label>
                                            <span>{{ __('dujiaoka.money_symbol') }}{{ $wholesale_discount_price }}</span>
                                        </div>
                                    @endif
                                    @if(!empty($info))
                                        <div class="mb-1">
                                            <label>{{ __('dujiaoka.order_information') }}:</label>
                                            <p>{{ $info }}</p>
                                        </div>
                                    @endif
                                    <div class="mb-1">
                                        <label>{{ __('order.fields.actual_price') }}:</label>
                                        <span>{{ __('dujiaoka.money_symbol') }}{{ $actual_price }}</span>
                                    </div>
                                    <div class="mb-1">
